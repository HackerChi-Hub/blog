...
- **装应用：** LocalBrain 1.2.62 已发布 macOS（Apple Silicon）与 Windows x64 安装包，下载库 https://github.com/HackerChi-Hub/localbrain-releases/releases 。Linux 目前没有可用的推理运行时，这次没有打包。
