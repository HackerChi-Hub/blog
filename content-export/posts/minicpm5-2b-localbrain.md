---
title: 1.4GB小模型，真能当本地智能体吗？
slug: minicpm5-2b-localbrain
status: published
date: 2026-09-09
updated: 2026-09-09
summary: MiniCPM5-2B 把 13 万上下文、Agent 训练和官方 GGUF/MLX 一起塞进 2.52B 参数；真正的看点不是越级跑分，而是它有没有资格成为本地软件里的常驻执行器。
categories:
  - 学习思考
tags:
  - AI
  - 热点速递
cover: /obsidian-assets/minicpm5-2b-localbrain/cover-812be1aa65.jpg
brand_slogan: 让AI成为你的超能力
legacy_paths: []
---

> [!abstract]
> 参数很小、格式齐全、上下文很长；先别把“能装进内存”写成“已经能干活”。
> 黑粉科技 · 2026-09-09

![当模型缩到 1.4GB，真正值得问的是它能否成为一直在线的本地执行器](/obsidian-assets/minicpm5-2b-localbrain/image-cover-wide-812be1aa65.jpg)
...
![MiniCPM5-2B 官方模型卡：模型定位、许可证、工具调用与端侧标签可直接核对](/obsidian-assets/minicpm5-2b-localbrain/image-official-card-985403ad2f.png)
...
![MiniCPM5-2B 的参数、上下文和官方本地格式；体积来自官方仓库文件](/obsidian-assets/minicpm5-2b-localbrain/image-facts-bad2493c95.png)
...
![权重体积只是入场券；聊天模板、工具协议与长上下文缓存才决定能否常驻](/obsidian-assets/minicpm5-2b-localbrain/image-runtime-fit-49e3eb6020.png)
...
> [!summary] 现在可以确认与不能确认的事
> 已经确认：2.52B 稠密模型，官方 MLX 4bit 约 1.42GB，GGUF Q4_K_M 约 1.56GB；标准 Llama 架构、13 万上下文，并有官方多端格式与 Agent 训练。尚未确认：LocalBrain 真实支持、工具成功率、Mac 速度与满上下文内存；本篇没有做推理实测。

> [!tip]
> **一手来源**
> MiniCPM 官方仓库：https://github.com/OpenBMB/MiniCPM
> MiniCPM5-2B：https://huggingface.co/openbmb/MiniCPM5-2B
> 官方 MLX 4bit：https://huggingface.co/openbmb/MiniCPM5-2B-MLX
> 官方 GGUF：https://huggingface.co/openbmb/MiniCPM5-2B-GGUF
> 
