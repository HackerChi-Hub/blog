...
export const SITE_CONFIG = {
  name: process.env.NEXT_PUBLIC_SITE_NAME || '黑粉科技 · 官网',
  description:
    process.env.NEXT_PUBLIC_SITE_DESCRIPTION ||
    '帮普通人用 AI 变强的技术朋友。掌握 AI 的人，将成为各个领域的王者。',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://hyphentech.top',
  author: process.env.NEXT_PUBLIC_SITE_AUTHOR || '黑粉科技',
  keywords:
    process.env.NEXT_PUBLIC_SITE_KEYWORDS ||
    'AI,人工智能,AI教程,AI工具,黑粉科技,技术博客',
  image: process.env.NEXT_PUBLIC_SITE_IMAGE || '/favicon-512x512.png',
  twitter: process.env.NEXT_PUBLIC_TWITTER_HANDLE || 'https://x.com/hyphentech99',
};
